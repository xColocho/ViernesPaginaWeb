...
function initDownloadButtons() {
    ...
    downloadButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            // Si tiene un enlace real de Play Store o App Store, dejar que funcione normalmente
            if (href && href !== '#' && href.includes('play.google.com')) {
                // Solo efecto visual, pero permitir que el enlace funcione
                this.style.transform = 'scale(0.95)';
                setTimeout(() => {
                    this.style.transform = '';
                }, 150);
                return; // Dejar que el navegador abra el enlace
            }
            
            // Para enlaces temporales (#), prevenir y mostrar mensaje
            e.preventDefault();
            ...
            // Mostrar mensaje de descarga solo para enlaces temporales
